...
const (
	OrderService_CreateOrder_FullMethodName     = "/tradedrift.order.v1.OrderService/CreateOrder"
	OrderService_CancelOrder_FullMethodName     = "/tradedrift.order.v1.OrderService/CancelOrder"
	OrderService_GetOrder_FullMethodName        = "/tradedrift.order.v1.OrderService/GetOrder"
	OrderService_ListOrders_FullMethodName      = "/tradedrift.order.v1.OrderService/ListOrders"
	OrderService_CancelAllOrders_FullMethodName = "/tradedrift.order.v1.OrderService/CancelAllOrders"
)
...
func (c *orderServiceClient) CancelAllOrders(ctx context.Context, in *CancelAllOrdersRequest, opts ...grpc.CallOption) (*CancelAllOrdersResponse, error) {
	...
	err := c.cc.Invoke(ctx, OrderService_CancelAllOrders_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _OrderService_CancelAllOrders_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: OrderService_CancelAllOrders_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var OrderService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "tradedrift.order.v1.OrderService",
