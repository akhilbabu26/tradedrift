...
func TestValidateStream(t *testing.T) {
	cases := []struct {
		...
		{"user:notifications:a0000000-0000-0000-0000-000000000001", protocol.StreamTypeNotification, "a0000000-0000-0000-0000-000000000001", true},
		{"user:portfolio:b0000000-0000-0000-0000-000000000002", protocol.StreamTypePortfolio, "b0000000-0000-0000-0000-000000000002", true},
		{"user:notifications:user-123", protocol.StreamTypeControl, "", false},
		{"user:portfolio:user-456", protocol.StreamTypeControl, "", false},
		{"user:notifications:../../traversal", protocol.StreamTypeControl, "", false},
		{"user:notifications:not-a-uuid", protocol.StreamTypeControl, "", false},
