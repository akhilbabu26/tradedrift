...
type Order struct {
	...
	Price             string                 `protobuf:"bytes,6,opt,name=price,proto3" json:"price,omitempty"`                                                  // Decimal string, empty for MARKET orders
...
const file_order_v1_order_proto_rawDesc = "" +
	"\n" +
	"\x14order/v1/order.proto\x12\x13tradedrift.order.v1\x1a\x1fgoogle/protobuf/timestamp.proto\"\xa3\x04\n" +
	"\x05Order\x12\x0e\n" +
